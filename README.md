...
#### 🎯 Быстрые команды для каждого профиля:

```bash
# Кластер 46 - Технологическое оборудование
npm run cli:c46-tech

# Кластер 46 - Новый концепт
npm run cli:c46-concept

# Кластер 49 - Технологическое оборудование
npm run cli:c49-tech

# Кластер 49 - Новый концепт
npm run cli:c49-concept

# Кластер 51 - Технологическое оборудование
npm run cli:c51-tech

# Кластер 51 - Новый концепт
npm run cli:c51-concept

# Все профили подряд (все кластеры, все темы)
npm run cli:all
```
...
- `c46-tech` — Кластер 46 - Технологическое оборудование
- `c46-concept` — Кластер 46 - Новый концепт
- `c49-tech` — Кластер 49 - Технологическое оборудование
- `c49-concept` — Кластер 49 - Новый концепт
- `c51-tech` — Кластер 51 - Технологическое оборудование
- `c51-concept` — Кластер 51 - Новый концепт
- `all-tech` — Все кластеры - Технологическое оборудование
- `all-concept` — Все кластеры - Новый концепт
- `all` — Все кластеры - Все темы

#### 🔧 Расширенное использование CLI:

```bash
# Запуск профиля с дополнительными фильтрами
npm run cli -- --profile c46-tech --date-from 2024-09-01

# Справка со всеми опциями
npm run cli -- --help

# Кастомные фильтры (без профиля)
npm run cli -- --clusters "Кластер Екатеринбург 46" --theme tech_equipment
```
